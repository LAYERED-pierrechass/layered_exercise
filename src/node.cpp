...
const std::vector<std::vector<double>> POINTS = {
    {1.0, 8.0, 0.0}, {3.0, 8.0, 1.57}, {3.0, 5.0, 0.0},  {1.0, 5.0, 0.6},
    {3.0, 3.0, 1.7}, {5.0, 3.0, 0.0},  {5.0, 8.0, 3.14}, {7.0, 8.0, 0.0},
    {7.0, 3.0, 2.0}, {5.0, 3.0, 0.0},  {9.0, 8.0, 0.0},  {7.0, 8.0, 0.0},
    {7.0, 6.0, 0.0}, {9.0, 6.0, 1.0},  {9.0, 4.0, 0.0},  {7.0, 4.0, 1.57}};
